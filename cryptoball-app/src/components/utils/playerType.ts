...
export const POTENTIAL_GOLD = "#f5c542";

export const getPotentialColor = (potential: bigint | number, fallback: string): string => {
    return Number(potential) >= 85 ? POTENTIAL_GOLD : fallback;
};
